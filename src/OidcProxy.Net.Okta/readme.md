...
This packages provides a custom IdentityProvider for Okta application pkce ingtegration.
It was needed to allow for minor configuration differences and to prevent validation errors when trying to run Okta with the existing Oidc provider.
